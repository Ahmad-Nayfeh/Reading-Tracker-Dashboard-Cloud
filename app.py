...
if not setup_complete:
    ...
    # --- صفحة الترحيب الاحترافية - الإصدار النهائي والمُصحح ---
    ...
    <style>
        ...
        .welcome-card {
            ...
            border-radius: 16px;
            padding: 1.5rem; /* تم تقليل حجم الحشو الداخلي للبطاقة */
            text-align: right;
        ...
        .welcome-card .icon {
            font-size: 3.5rem; /* تم تصغير حجم الأيقونة قليلاً */
            line-height: 1;
            margin-bottom: 1rem;
            color: #2980b9;
        }
        .welcome-card h3 {
            ...
            font-size: 1.7rem; /* تم تصغير حجم العنوان قليلاً */
            font-weight: 700;
            color: #2c3e50;
            margin-bottom: 1rem;
        }
        .welcome-card p {
            font-family: 'Tajawal', sans-serif;
            font-size: 1.1rem; /* تم تصغير حجم النص قليلاً */
            color: #5D6D7E;
            line-height: 1.7;
            flex-grow: 1; 
        }
    ...
    with col1:
        ...
        <div class="welcome-card">
            ...
            <a href="لوحة_التحكم_العامة" target="_self" class="card-link">اذهب للوحة التحكم ←</a>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col2:
        ...
        <div class="welcome-card">
            ...
            <a href="تحليلات_التحديات" target="_self" class="card-link">استكشف التحليلات ←</a>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col3:
        ...
        <div class="welcome-card">
            ...
            <a href="الإدارة_والإعدادات" target="_self" class="card-link">تحكم في الإعدادات ←</a>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col4:
        ...
        <div class="welcome-card">
            ...
            <a href="عن_التطبيق" target="_self" class="card-link">اقرأ المزيد ←</a>
        </div>
        """, unsafe_allow_html=True)