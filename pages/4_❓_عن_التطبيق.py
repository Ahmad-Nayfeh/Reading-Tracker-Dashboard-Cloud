...
def render_card(icon, title, content_html):
    st.markdown(f"""
...
"""
render_card("🎯", "نظام المسابقات والنقاط: فلسفة التحفيز الذكي", philosophy_html)
...
"""
render_card("📰", "نشرة الماراثون: كيف تعمل \"آخر الأخبار\"؟", news_html)
...
"""
render_card("🤔", "أسئلة شائعة", qa_html)
